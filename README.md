...
Aplikacja stworzona na rzecz dyplomu inżynierskiego Mateusz Gościnieckiego.
...
## Główne informacje
Program ten został napisany na podstawie pracy inżynierskie pt. 
"Narzędzie do wizualizacji propagacji fal w liniach transmisyjnych opisanych modelami matematycznymi niecałkowitego rzędu".
Aplikacja adaptuje treść obliczeniową dyplomu do Pythona. Parametry wprowadzane są przy pomocy GUI,
a wizualizacja fal odbywa się przy pomocy wykresu. Program ma wbudowaną obsługę błędów.

## Użyte technologie
Matematyczna część została opisana w pracy inżynierskiej. Wszystkie zewnętrzne biblioteki użyte w projekcie
wypisane są w pliku "requirements.txt".
...
znajduje się okno wykresu odpowiedzialne za wizualizację propagacji fal. W kodzie okno to zrealizowane jest
przy pomocy jednej klasy "App". Klasa ta zawiera 4 funkcji. Funkcje "first_panel_init", "second_panel_init"
...
na zadane pobudzenie. Szczegółowy opis zachodzących tu obliczeń został przedstawiony we wspomnianej już
